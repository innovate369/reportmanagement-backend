...
const addProfile = async (req, res) => {
  const { companyName, email, address, contactNum, gstNum, bankName, ifsc, ownerName, bankType, accountNum, panNum, logo } = req.body
  const newProfile = { companyName, email, address, contactNum, gstNum, bankName, ifsc, ownerName, bankType, accountNum, panNum, logo, logoName: req.files.logo[0].filename }
